  ...
  return (
    <div className='flex flex-row bg-black rounded-xl px-5 py-5 justify-center items-center drop-shadow-xl bg-cerulean-blue w-fit h-fit hover:scale-105 duration-300'>
      ...
      <div className='flex grid grid-cols-1 px-4 h-fit gap-2'>
        ...
        <button className="px-4 py-1 text-sm text-white font-semibold rounded-full border border-purple-200 hover:text-white hover:bg-purple-600 hover:border-transparent focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-offset-2 mt-2">Contact</button>
      </div>
    </div>
  );
}
